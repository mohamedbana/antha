// antha/cmd/anthadoc/main.go: Part of the Antha language
...
// anthadoc: Antha Documentation Server

// Web server tree:
//
//	http://anthadoc/		main landing page
//	http://anthadoc/doc/	serve from $GOROOT/doc - spec, mem, etc.
//	http://anthadoc/src/	serve files from $GOROOT/src; .go gets pretty-printed
//	http://anthadoc/cmd/	serve documentation about commands
//	http://anthadoc/pkg/	serve documentation about packages
//				(idea is if you say import "compress/zlib", you go to
//				http://anthadoc/pkg/compress/zlib)
//
// Command-line interface:
//
//	anthadoc packagepath [name ...]
//
//	anthadoc compress/zlib
//		- prints doc for package compress/zlib
//	anthadoc crypto/block Cipher NewCMAC
...
const (
	...
	toolsPath   = "antha-tools/anthadoc/cmd/"
)
...
var (
	...
	analysisFlag = flag.String("analysis", "", `comma-separated list of analyses to perform (supported: type, pointer). See http://golang.org/lib/anthadoc/analysis/help.html`)
...
func usage() {
	fmt.Fprintf(os.Stderr,
		"usage: anthadoc package [name ...]\n"+
			"	anthadoc -http="+defaultAddr+"\n")
	flag.PrintDefaults()
	os.Exit(2)
}
...
func main() {
	...
	if *templateDir != "" {
		fs.Bind("/lib/anthadoc", vfs.OS(*templateDir), "/", vfs.BindBefore)
	} else {
	...
	if httpMode {
		...
		if *verbose {
			log.Printf("Antha Documentation Server")
	...
	if err := anthadoc.CommandLine(os.Stdout, fs, pres, flag.Args()); err != nil {
		log.Print(err)
	}
}