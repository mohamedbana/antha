...
func makePlateLibrary() map[string]*wtype.LHPlate {
	...
	*/
	...
	plate = wtype.NewLHPlate("EGEL96_1", "Invitrogen", 4, 13, 48.5, "mm", welltype, 9, 18.0, -9.0, -1.0, riserheightinmm+5.5)
	...
	plate = wtype.NewLHPlate("EGEL96_2", "Invitrogen", 4, 13, 48.5, "mm", welltype, 9, 18.0, -5.0, 8, riserheightinmm+5.5)
