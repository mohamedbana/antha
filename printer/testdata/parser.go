// antha/printer/testdata/parser.go: Part of the Antha language
...
// output is an abstract syntax tree (AST) representing the Antha source. The
...
func (p *parser) parseFile() *ast.File {
	...
	// Likely not a Go/Antha source file at all.
