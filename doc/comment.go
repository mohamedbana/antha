// antha/doc/comment.go: Part of the Antha language
...
// Anthadoc comment extraction and comment -> HTML formatting.
...
// into a link). Antha identifiers that appear in the words map are italicized; if
