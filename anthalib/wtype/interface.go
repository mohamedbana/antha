...
func MakeMatterLib() map[string]GenericMatter{
	...
	mps:=[]float64{160.0, 292.0, 326.8, 1000.0, 1370.0, 0, 17.8, -114.0, 0.0}
	bps:=[]float64{100000.0, 100000.0, 100000.0, 100000.0, 1000000.0, 100.0, 290.0, 78.37, 100.0}
	shcs:=[]float64{900.0, 1200.0, 1300.0, 840.0, 420.0, 4181.0, 221.9, 2.46, 4181.0}
