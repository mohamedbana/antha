...
func (plate *LHPlate)MarshalJSON()([]byte,error){
	slp:=SLHPlate{plate.ID,plate.Inst,plate.Loc,plate.Name,plate.Type,plate.Mnfr,plate.WellsX,plate.WellsY,plate.Nwells,plate.Height,plate.Hunit,plate.Welltype,plate.Wellcoords, plate.Welldimensions()}
