...
func (e *Colony_PCR) requirements() {
	_ = wunit.Make_units

}

// Conditions to run on startup
func (e *Colony_PCR) setup(p Colony_PCRParamBlock) {
...
// for every input
func (e *Colony_PCR) steps(p Colony_PCRParamBlock, r *Colony_PCRResultBlock) {
	_wrapper := execution.NewWrapper(p.ID, p.BlockID, p)
	_ = _wrapper
...
func (e *Colony_PCR) analysis(p Colony_PCRParamBlock, r *Colony_PCRResultBlock) {
	_wrapper := execution.NewWrapper(p.ID, p.BlockID, p)
	_ = _wrapper
	_ = _wrapper.WaitToEnd()
...
// dipstick basis
func (e *Colony_PCR) validation(p Colony_PCRParamBlock, r *Colony_PCRResultBlock) {
	_wrapper := execution.NewWrapper(p.ID, p.BlockID, p)
	_ = _wrapper
	_ = _wrapper.WaitToEnd()
...
// AsyncBag functions
func (e *Colony_PCR) Complete(params interface{}) {
	p := params.(Colony_PCRParamBlock)
	if p.Error {
		e.Reaction <- execute.ThreadParam{Value: nil, ID: p.ID, Error: true}
		return
	}
	r := new(Colony_PCRResultBlock)
	defer func() {
...
func (e *Colony_PCR) init() {
	e.params = make(map[execute.ThreadID]*execute.AsyncBag)
}

func (e *Colony_PCR) NewConfig() interface{} {
	return &Colony_PCRConfig{}
}

func (e *Colony_PCR) NewParamBlock() interface{} {
	return &Colony_PCRParamBlock{}
}

func NewColony_PCR() interface{} { //*Colony_PCR {
	e := new(Colony_PCR)
	e.init()
	return e
}
...
// Mapper function
func (e *Colony_PCR) Map(m map[string]interface{}) interface{} {
	var res Colony_PCRParamBlock
...
func (e *Colony_PCR) OnAdditiveconc(param execute.ThreadParam) {
	e.lock.Lock()
...
func (e *Colony_PCR) OnAdditives(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnAnnealingTemp(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnAnnealingtime(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnBuffer(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnDNTPS(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnDNTPconc(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnDenaturationtime(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnExtensiontemp(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnExtensiontime(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnFinalextensiontime(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnFwdPrimer(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnFwdPrimerConc(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnInitDenaturationtime(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnNumberofcycles(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnOutPlate(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnPCRPolymerase(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnReactionVolume(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnRevPrimer(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnRevPrimerConc(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnTargetpolymeraseConcentration(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnTemplate(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
func (e *Colony_PCR) OnTemplatevolume(param execute.ThreadParam) {
	e.lock.Lock()
	var bag *execute.AsyncBag = e.params[param.ID]
	if bag == nil {
		bag = new(execute.AsyncBag)
...
type Colony_PCRParamBlock struct {
	ID                            execute.ThreadID
...
type Colony_PCRResultBlock struct {
	ID       execute.ThreadID
	BlockID  execute.BlockID
	Error    bool
...
type Colony_PCRJSONBlock struct {
	ID                            *execute.ThreadID
	BlockID                       *execute.BlockID
	Error                         *bool
	Additiveconc                  *wunit.Concentration
...
func (c *Colony_PCR) ComponentInfo() *execute.ComponentInfo {
	...
	ci := execute.NewComponentInfo("Colony_PCR", "Colony_PCR", "", false, inp, outp)
