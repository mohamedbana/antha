...
func init() {
	addComponent(Component{Name: "CombinatorialLibraryDesign_L1PRO_RBS_CDS_TerL1_wtype_map",
		...
		Desc: ComponentDesc{
			...
			Path: "antha/component/an/Data/DNA/TypeIISAssembly_design/CombinatorialLibraryDesign4part_Hierarchical.an",
			Params: []ParamDesc{
