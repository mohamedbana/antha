...
func Make_units() map[string]GenericUnit {
	units := []string{"M", "m", "l", "L", "g", "V", "J", "A", "N", "s", "radians", "degrees", "rads", "Hz", "rpm", "˚C", "M/l", "g/l", "J/kg", "Pa", "kg/m^3"}
	unitnames := []string{"mole", "minute", "litre", "litre", "Gramme", "Volt", "Joule", "Ampere", "Newton", "second", "radian", "degree", "radian", "Herz", "revolutions per minute", "Celsius", "Mol/litre", "g/litre", "Joule/kilogram", "Pascal", "kg per cubic meter"}
