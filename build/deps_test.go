// antha/build/deps_test.go: Part of the Antha language
...
// the Antha source tree.  It is a statement of policy.
...
var pkgDeps = map[string][]string{
	...
	// Go/Antha parser.
	"antha/ast":     {"L4", "OS", "antha/scanner", "antha/token"},
	"antha/doc":     {"L4", "antha/ast", "antha/token", "regexp", "text/template"},
	"antha/parser":  {"L4", "OS", "antha/ast", "antha/scanner", "antha/token"},
	"antha/printer": {"L4", "OS", "antha/ast", "antha/scanner", "antha/token", "text/tabwriter"},
	"antha/scanner": {"L4", "OS", "antha/token"},
	"antha/token":   {"L4"},
...
// (currently just "no Go/Antha source files")
